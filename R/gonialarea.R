#' Mandibular Angle Slice
#'
#' Isolates the mandibular angles, flips to horizontal, and culls backfaces.
...
gonialarea <- function(sample, filename, folder, saveplots = TRUE){
  ...
  msg <- paste("Isolating mandibular angles for mandible", str_replace(filename, "VERT", ""))
  message(msg)
